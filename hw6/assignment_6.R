...
adj_deg_df =  data.frame(adj_deg)
aic_deg_df =  data.frame(aic_deg)
cv_deg_df =  data.frame(cv_deg)

ggplot(adj_deg_df, aes(x = adj_deg)) +
  geom_histogram(color = "black", fill = "lightblue", bins = 20) +
  labs(title = "Distribution of Polynomial Degrees for Adjusted R Squared",
       x = "Polynomial Degree",
       y = "Frequency")

ggplot(aic_deg_df, aes(x = aic_deg)) +
  geom_histogram(color = "black", fill = "lightgreen", bins = 20) +
  labs(title = "Distribution of Polynomial Degrees for AIC",
       x = "Polynomial Degree",
       y = "Frequency")

ggplot(cv_deg_df, aes(x = cv_deg)) +
  geom_histogram(color = "black", fill = "mistyrose", bins = 20) +
  labs(title = "Distribution of Polynomial Degrees for CV",
       x = "Polynomial Degree",
       y = "Frequency")
